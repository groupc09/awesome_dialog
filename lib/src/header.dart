  ...
  Widget build(BuildContext context) {
    switch (dialogType) {
      ...
      case DialogType.infoReverse:
        return Expanded(child: FittedBox(fit: BoxFit.contain, child: Icon(Icons.info, color: Colors.lightGreen)));
        // return RiveAssetAnimation(
      ...
      case DialogType.question:
        return Expanded(child: FittedBox(fit: BoxFit.contain, child: Icon(Icons.question_mark, color: Colors.blue,)));
        // return RiveAssetAnimation(
        //   assetPath: 'packages/awesome_dialog/assets/rive/question.riv',
        //   animName: loop ? 'appear_loop' : 'appear',
        // );
      case DialogType.warning:
        return Expanded(child: FittedBox(fit: BoxFit.contain, child: Icon(Icons.warning, color: Colors.yellow,)));
        // return RiveAssetAnimation(
        //   assetPath: 'packages/awesome_dialog/assets/rive/warning.riv',
        //   animName: loop ? 'appear_loop' : 'appear',
        // );
      case DialogType.error:
        return Expanded(child: FittedBox(fit: BoxFit.contain, child: Icon(Icons.error, color: Colors.red,)));
        // return RiveAssetAnimation(
        //   assetPath: 'packages/awesome_dialog/assets/rive/error.riv',
        //   animName: loop ? 'appear_loop' : 'appear',
        // );
      case DialogType.success:
        return Expanded(child: FittedBox(fit: BoxFit.contain, child: Icon(Icons.check_circle, color: Colors.green,)));
        // return RiveAssetAnimation(
